                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">{{ $selectedClass['teacher']['user']['name'] }}
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">{{ $selectedClass['classroom']['name'] ?? 'N/A' }}</p>
                            </div>
                            <div>
                        ...
                        <!-- Estudiantes -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Estudiantes Inscriptos</label>
            ...
            Livewire.on('notify', (event) => {
                ...
                if (window.filament) {
                    window.filament.notify({
                        title: event.message,
                        icon: event.type === 'error' ? 'x-circle' : 'check-circle',
                        color: event.type === 'error' ? 'danger' : 'success',
                    });
                } else {
